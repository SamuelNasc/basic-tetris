document.addEventListener('DOMContentLoaded', () => {
  ...
  // move the tetromino left, unless is it at the edge or there is a blockage
  function moveLeft () {
    undraw()
  ...
  // move the tetrominoe rigth, unless is at the edge or there is a blockage
  function moveRigth () {
    undraw()
  ...
  // the tetrominos whitout rotations
  ...
  function displayShape () {
    //  remove any trace of a tetromino of the entire mini-grid
  ...
  // add funcionality to the startButton
